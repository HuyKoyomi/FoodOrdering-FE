...
export default function Reservation({ ...props }) {
  const { id, name, image, price, reviews, rating, category, location } =
    props.route.params;
  return (
...
const ReservationForm = (props) => {
  ...
  const addReservation = () => {
    if (quantity == "" || time == "") alert("Vui lòng nhập đầy đủ thông tin");
    else
      axios
        .post("http://10.0.2.2:3000/reservation/addOne", {
          restaurant: props.id,
          client: user._id,
